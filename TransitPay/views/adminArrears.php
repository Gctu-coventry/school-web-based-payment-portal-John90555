	...
	<div class="sidebar">
		...
		<div class="sidebar-menu">
			<ul>
				...
				<li><a href="adminArrears.php" class="active"><span class="las la-file-invoice-dollar"></span><span>View Arrears</span></a></li>
				...
				<div class="card">
					...
					<div class="table-responsive">
							...
							<tbody>
								...
								<?php echo $interact->viewarrears(); }else{?><div class="nothing"><?php echo "No Transaction History";?></div><?php }?>
