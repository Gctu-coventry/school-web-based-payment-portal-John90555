...
$valid = new Validate($db);
  ...
  if (isset($_SESSION['token']) && isset($_SESSION['product_id'])) {
      ...
      case true:
        ...
        switch ($v) {
          ...
          case 'notgenerated':
            ...
            $_SESSION['jwt'] = $J_W_T;
            echo "<script>window.location.replace('http://localhost/LifeLineBank/views/refund.php?gen','blank').focus()</script>";
            //$bank->check_status();
            break;
            default:
            echo 'Not';
