	...
	<div class="sidebar">
		...
		<div class="sidebar-menu">
			<ul>
				...
				<li><a href="adminPending.php" class="active"><span class="las la-hourglass-half"></span><span>Pending Refunds</span></a></li>
			...
			<div class="projects">
				<div class="card">
					...
					<div class="table-responsive">
							...
							<?php 
  $c = curl_init(); 
  curl_setopt($c, CURLOPT_URL,'http://localhost/work/historyApi.php');
