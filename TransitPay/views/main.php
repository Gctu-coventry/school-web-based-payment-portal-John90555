	...
	<div class="sidebar">
		...
		<div class="sidebar-menu">
			<ul>
				...
				<li><a href="main.php" class="active"><span class="las la-bars"></span><span>Dashboard</span></a></li>
...
<div id="account">Account No: <?php echo $obj->bank_account_number;?></div>			<div class="user-wrapper">
			...
			Welcome <?php echo $obj->firstname; echo '&nbsp'. $obj->lastname; ?>
	...
	<main>
		...
		<a href="pending.php" style="text-decoration: none; color: black;">
			<div class="card-single">
				<div class="n">
					<span><?php echo $interact->countPending();'&nbsp'?> Pending Transactions</span><span class="las la-hourglass-half"></span>
					<h1></h1>
				...
				<div class="card">
					...
					<div class="table-responsive">
							...
							<tbody>
								...
								<?php echo $interact->history(); }else{?><div class="nothing"><?php echo "No Transaction History";?></div><?php }?>
